...
const ImageEditorCanvas: React.FC<ImageEditorCanvasProps> = ({ onImagesSelect, initialImageUrl, onMaskChange, onClearImage, isMaskToolActive, allowMultiple }) => {
        ...
        >
            {!initialImageUrl ? (
                <label htmlFor="file-upload" className="flex flex-col items-center justify-center text-[var(--text-tertiary)] cursor-pointer w-full h-full">
                    ...
                    <input id="file-upload" type="file" className="hidden" onChange={handleFileChange} accept="image/*" multiple={allowMultiple} />
                </label>
            ) : (
                <>
